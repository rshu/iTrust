...
public class HCPViewPatientOfficeVisitsStepDefs extends CucumberTest {
     ...
     * 
     * @param hcpType type of the HCP
     */
    @Given("^there exists an (.+) HCP in the iTrust system$")
    public void HCPExists(String hcpType) {
        attemptLogout();
        ...
        switch (hcpType) {
        case OPH_HCP_TYPE:
            hcp = new User(ophHcpString, "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.", Role.ROLE_OPH,
                    1);
            break;
        case OD_HCP_TYPE:
            hcp = new User(odHcpString, "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.", Role.ROLE_OD,
                    1);
            break;
        default:
            hcp = new User(hcpString, "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.", Role.ROLE_HCP, 1);
        }
        hcp.save();
    }

    /**
     * The given type of HCP logs in and navigates to the view patient office visits
     * page
     * 
     * @param hcpType type of the HCP
     */
    @Then("^the (.+) HCP logs in and navigates to the view patient office visits page$")
    public void hcpLoginNavToView(String hcpType) {
        attemptLogout();
    ...
    /**
     * Checks that of all the patient office visits shown, the HCP can see at least
     * of of each type
     */
     ...
     * 
     * @param visitType type of office visit
     */
    @When("^the HCP selects (.+) office visit it shows the correct visit information$")
    public void hcpSelectOfficeVisit(String visitType) {
        waitForAngular();
        int value = 1;
    ...
    private GeneralCheckup getGenCheckup() {
        ...
        form.setDate("2036-02-14T15:50:00.000-05:00"); // 2/14/2036 3:50 PM EST
        form.setHcp("hcp");
    ...
    private OphthalmologySurgery getOphSurgery() {
        ...
        visit.setDate("2048-04-16T09:50:00.000-04:00"); // 4/16/2048 9:50 AM EDT
        visit.setHcp("hcp");
    ...
    private void validateGenCheckup() {
        ...
        assertEquals("Injury of lumbar and sacral spinal cord. Probably carrying teammates.", driver.findElement(By.name("diagnoseDesc")).getText());
    ...
    private void validateGenOph() {
        ...
        assertEquals("20/20", driver.findElement(By.name("acuityOD")).getText());
        assertEquals("20/40", driver.findElement(By.name("acuityOS")).getText());
    ...
    private void validateOphSurgery() {
        ...
        String time = driver.findElement(By.name("time")).getText();
