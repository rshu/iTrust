...
public class PatientViewOfficeVisitStepDefs extends CucumberTest {
  ...
  public void HCPExists() {
    attemptLogout(); 
		...
		final User patient = new User(patientString, "$2a$10$EblZqNptyYvcLm/VwDCVAuBjzZOI7khzdyGPBr08PpIi0na624b8.", Role.ROLE_PATIENT, 1);
    patient.save();
  }

  /**
   * Deletes all current office visits and creates one of each type for the
   * patient
   */
  ...
  public void hcpLoginNavToView() {
    ...
    assertEquals("iTrust2: View Office Visits", driver.getTitle());
  }
   ...
   */
  @When("^the patient selects (.+) office visit it shows the correct visit information$")
  public void HPCSelectOfficeVisit(String visitType) {
    waitForAngular();
    int value = 1;
