...
public class OphthalmologySurgeryForm extends OphthalmologyVisitForm {
     ...
     * @param ov office visit to create form from
     */
    public OphthalmologySurgeryForm( OphthalmologySurgery ov ) {
        super( ov );
     ...
     * @param surgeryType the surgery type to set
     */
    public void setSurgeryType(EyeSurgeryType surgeryType) {
